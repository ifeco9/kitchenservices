        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 stagger-children">
          {categories.map((category) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-surface group-hover:bg-accent rounded-lg transition-all duration-300 flex-shrink-0">
                  <Icon
                    ...
                    size={24}
                    className="text-primary group-hover:text-accent-foreground transition-all duration-300"
                  />
                </div>
                {category.badge && (
              ...
              <h3 className="text-lg font-semibold text-primary mb-2 group-hover:text-accent transition-all duration-300">
                {category.title}
              </h3>
              <p className="text-text-secondary text-sm leading-relaxed mb-4">{category.description}</p>

              <div className="flex items-center text-accent text-sm font-medium group-hover:translate-x-1 transition-all duration-300">
                <span>Book Now</span>
